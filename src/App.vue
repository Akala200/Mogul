	...
	<div class="ui inverted vertical masthead center aligned segment">
  		<div class="ui container">
    		  <div class="ui large secondary inverted pointing menu">
      			...
      			<a class="item logo">
      				<router-link to="/"><i class="mixcloud large icon"></i>Mogul</router-link>
  				</a>
  		...
  		<div class="ui container">
  		  <div class="ui stackable inverted divided equal height stackable grid">
  			...
  			<div class="seven wide column">
  			  <h4 class="ui inverted header">About Mogul</h4>
  			  <p>As the world’s largest music and audio platform, Mogul lets people discover and enjoy the greatest
